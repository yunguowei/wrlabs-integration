...
KMACHINE_intel-corei7-64 = "${@bb.utils.contains('BSP_SUBTYPE', 'leafhill', 'leafhill', 'computestick', d)}"
KBRANCH_intel-corei7-64 = "${@bb.utils.contains('BSP_SUBTYPE', 'leafhill', 'standard/intel/4.1.27/leaf-hill', 'standard/next', d)}"
...
SRCREV_machine_intel-corei7-64 = "${@bb.utils.contains('BSP_SUBTYPE', 'leafhill', '6e06dacda21b3de803e5ca03b8d14e1021861b30', '6f5b20efc9ddb8823b0af991e94af91eee44df86', d)}"
...
LINUX_VERSION_intel-corei7-64 = "${@bb.utils.contains('BSP_SUBTYPE', 'leafhill', '4.1.27', '4.1.33', d)}"
